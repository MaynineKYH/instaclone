    ...
    <View style={{
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={{
          ...
          <AntDesign name='pluscircleo' style={{fontSize:40, opacity:0.2}}/>
        </TouchableOpacity>
      </ScrollView>
      {
        image ? 
        (
          <View style={{
            ...
            width:'100%',
            height:'100%',
            backgroundColor:'rbga(52,52,52,0.8)'
          }}>
            ...
            justifyContent:'space-around', width:'100%',alignItems:'center',padding:8}}>
